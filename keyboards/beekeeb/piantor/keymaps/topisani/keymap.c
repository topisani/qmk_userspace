...
*/
#define LAYOUT36(K1, K2, K3, K4, K5, NO5,NO6, K6, K7, K8, K9, K10, K11, K12, K13,      \
                 K14, K15, NO15, NO16, K16, K17, K18, K19, K20, K21, K22, K23, K24,    \
                 K25, NO25,NO26, K26, K27, K28, K29, K30, NO1, NO2, NO3, K31, K32,     \
                 K33, K34, K35, K36, NO4, NO7, NO8)                                    \
    LAYOUT_split_3x6_3(                                                                                        \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV]=LAYOUT36(
        ...
        OLGUI   , KC_1    , KC_2    , KC_3    , KC_RBRC , .......    , ....... , DK_AA   , KC_HOME , KC_DOWN , KC_END  , DEAD_GREEK    , 
        ....... , ....... , ....... , _______ , PANIC   , OSL(_NAV)  , _______ , _______ , _______ , ....... , ....... , .......
    ),
    [_MOUSE]=LAYOUT36(
        _______ , MS_BTN3 , MS_BTN2 , MS_BTN1 , XXXXXXX , .......    , ....... , TABP    , MS_WHLU , MS_BTN1 , MS_WHLD , TABN     , 
        XXXXXXX , HA(NO)  , HLS(NO) , HC(NO)  , XXXXXXX , .......    , ....... , MS_BTN4 , MS_LEFT , MS_UP   , MS_RGHT , MS_BTN5  , 
        XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , .......    , ....... , XXXXXXX , MS_WHLL , MS_DOWN , MS_WHLR , XXXXXXX  , 
        ....... , ....... , ....... , _______ , PANIC   , TO(_MOUSE) , _______ , _______ , _______ , ....... , ....... , .......
    ),
    [_SYS]=LAYOUT36(
        XXXXXXX , KC_F7   , KC_F8   , KC_F9   , KC_F10  , .......    , ....... , KC_INS  , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX  , 
